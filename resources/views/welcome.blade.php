...
<head>
    ...
    <title>Street - Make Your Day</title>
                                ...
                                <svg width="32" height="32" viewBox="0 0 32 32"
                                    ...
                                    <g fill="none" fill-rule="evenodd">
                                        ...
                                        <path
                                            ...
                                            fill="url(#logo-b)" transform="matrix(-1 0 0 1 24.59 0)" />
                                    </g>
                                </svg>
                            </a>
                        </h1>
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
                        <div class="hero-copy">
                            <h1 class="hero-title mt-0">Street - Make Your Day</h1>
                            <p class="hero-paragraph">Street - trends start here. On a device or on the web, viewers can watch and discover millions of personalized short videos.</p>
                            <div class="hero-cta">
                                <a class="button button-primary button-shadow" href="#">Street Web</a>
                            </div>
                        </div>
                        <div class="hero-app">
                            <div class="hero-app-illustration">
                                <svg width="999" height="931" xmlns="http://www.w3.org/2000/svg">
                                    <defs>
                                        ...
                                        <linearGradient x1="92.827%" y1="0%" x2="53.406%" y2="80.12%"
                                            id="hero-shape-b">
                                    ...
                                    <g fill="none" fill-rule="evenodd">
                                        ...
                                        <g transform="translate(191 416)">
                                            <g class="is-moving-object is-translating" data-translating-factor="50">
                                                <circle fill="url(#hero-shape-c)" cx="336" cy="190"
                                                    r="190" />
                                            </g>
                            ...
                            <img class="device-mockup" src="{{asset('dist')}}/images/iphone-mockup.png" alt="App preview">
        ...
        <footer class="site-footer">
            <div class="container">
                <div class="site-footer-inner has-top-divider">
                        ...
                        <a href="#">
                            <svg width="32" height="32" viewBox="0 0 32 32"
                                ...
                                <g fill="none" fill-rule="evenodd">
                                    ...
                                    <path
                                        d="M13.666 31.889c7.547 0 10.924-7.307 10.924-14.854 0-7.547-3.377-7.027-10.924-7.027C6.118 10.008 0 13.055 0 20.603c0 7.547 6.118 11.286 13.666 11.286z"
                                        fill="url(#logo-footer-b)" transform="matrix(-1 0 0 1 24.59 0)" />
                                </g>
                            </svg>
                        </a>
                    </div>
                    ...
                    <div class="footer-copyright">&copy; 2022 Street, all rights reserved</div>
                </div>
            </div>
        </footer>
    </div>
